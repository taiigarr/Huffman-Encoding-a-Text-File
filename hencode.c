/* From: http://cppgm.blogspot.com/search?q=huffman
 *
 * Huffman Coding in C . This program reads a text file named on the
 * command line, then compresses it using Huffman coding. The file is read
 * twice, once to determine the frequencies of the characters, and again to
